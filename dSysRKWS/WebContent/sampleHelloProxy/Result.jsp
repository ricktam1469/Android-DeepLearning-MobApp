...
<jsp:useBean id="sampleHelloProxyid" scope="session" class="com.ricktam.dSysRKWS.HelloProxy" />
<%
...
case 10:
        gotMethod = true;
        com.ricktam.dSysRKWS.Hello getHello10mtemp = sampleHelloProxyid.getHello();
