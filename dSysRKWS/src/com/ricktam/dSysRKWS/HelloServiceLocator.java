...
public class HelloServiceLocator extends org.apache.axis.client.Service implements com.ricktam.dSysRKWS.HelloService {
    ...
    private java.lang.String Hello_address = "http://tempuri.org/dSysRKWS/services/Hello";
    ...
    public com.ricktam.dSysRKWS.Hello getHello(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ricktam.dSysRKWS.HelloSoapBindingStub _stub = new com.ricktam.dSysRKWS.HelloSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ricktam.dSysRKWS.Hello.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ricktam.dSysRKWS.HelloSoapBindingStub _stub = new com.ricktam.dSysRKWS.HelloSoapBindingStub(new java.net.URL(Hello_address), this);
                _stub.setPortName(getHelloWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://dSysRKWS.ricktam.com", "HelloService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://dSysRKWS.ricktam.com", "Hello"));
        }
