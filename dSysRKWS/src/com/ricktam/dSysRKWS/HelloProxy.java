...
public class HelloProxy implements com.ricktam.dSysRKWS.Hello {
  private String _endpoint = null;
  private com.ricktam.dSysRKWS.Hello hello = null;
  ...
  private void _initHelloProxy() {
    try {
      hello = (new com.ricktam.dSysRKWS.HelloServiceLocator()).getHello();
      if (hello != null) {
        if (_endpoint != null)
  ...
  public com.ricktam.dSysRKWS.Hello getHello() {
    if (hello == null)
      _initHelloProxy();
    return hello;
  }
